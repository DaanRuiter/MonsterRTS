...
[System.Serializable]
public class DynamicEntity : IEntity, System.ICloneable
{
    ...
    {
        SetProperty("identity", "New Dynamic Entity");
    ...
    public int x
    {
        get
        {
            return WorldManager.TileAtGamePos(m_gameObject.transform.position).x;
        }
        set
        {
    ...
    public int y
    {
        get
        {
            return WorldManager.TileAtGamePos(m_gameObject.transform.position).y;
        }
        set
        {
